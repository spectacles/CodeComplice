...
class CitadelLangIntel(LangIntel):
    ...
    """
    def _matches_codeintel_scan_exclude_dir(self, dir, exclude_patterns):
    ...
    def _extra_dirs_from_env(self, env):
        ...
        if extra_dirs:
            ...
            extra_dirs = [os.path.realpath(d) for d in extra_dirs if not self._matches_codeintel_scan_exclude_dir(d, exclude_patterns)]
        else:
